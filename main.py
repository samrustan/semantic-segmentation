...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # skip layer connection by element-wise addition
    ...
    # scale by 8 to return to original image size 
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    # keep prob and learning rate from Term1 notes
...
def run():
    ...
    with tf.Session() as sess:
        ...
        # TODO: Train NN using the train_nn functionA
